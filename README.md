...
> /listaveicoli/:tratta
![](Immagini/SequenceDiagram/diagramma_sequnze_admin_tratta.png)

> /stat/:targa/:tratta
![](immagini_esempi//SequenceDiagramdiagramma_sequnze_admin_stat_targa.png)
